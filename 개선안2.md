> ARCHIVE/REDIRECT (2025-09-09): 이 문서는 역사적 참고용입니다. 현재 표준은 CURRENT_STANDARD.md를 단일 소스로 사용하세요. API와 보안/구매 표준은 API_MAPPING_UPDATED.md 및 STATUS_PURCHASE_SECURITY.md를 우선 참조하세요.
